 ...
 */
class Magegiant_Facebook_ApiException extends Exception
{
  /**
...
abstract class BaseFacebook
{
  ...
  protected function getUserFromAccessToken() {
    try {
      ...
      return $user_info['id'];
    } catch (Magegiant_Facebook_ApiException $e) {
      return 0;
    }
  }
   ...
   * @throws Magegiant_Facebook_ApiException
   */
  protected function _restserver($params) {
    ...
    if (is_array($result) && isset($result['error_code'])) {
      throw new Magegiant_Facebook_ApiException($result);
    }
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new Magegiant_Facebook_ApiException(array(
  ...
  protected function throwAPIException($result) {
    $e = new Magegiant_Facebook_ApiException($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
