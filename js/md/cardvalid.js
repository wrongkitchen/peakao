...
Validation.addAllThese([
    ['validate-cccybersource-number', 'Please enter a valid credit card number.', function(v, elm) {
        // remove non-numerics
        ...
        if (ccTypeContainer.value == 'OT' ||  ccTypeContainer.value == 'UKE' || ccTypeContainer.value == 'DELTA' || ccTypeContainer.value == 'MAESTRO' || ccTypeContainer.value == 'SOLO' || ccTypeContainer.value == 'SWITCH' || ccTypeContainer.value == 'LASER' || ccTypeContainer.value == 'DC') {
            return true;
        }

        return validateCreditCard(v);
    }],
    ['validate-cccybersource-cvn', 'Please enter a valid credit card verification number.', function(v, elm) {
    ...
    ['validate-cccybersource-type', 'Credit card number doesn\'t match credit card type', function(v, elm) {
        ...
        if (ccType == 'MCDEBIT' || ccType == 'OT' ||  ccType == 'UKE' || ccType == 'DELTA' || ccType == 'MAESTRO' || ccType == 'SOLO' || ccType == 'SWITCH' || ccType == 'LASER' || ccType == 'DC') {
            return true;
        }  
    ...
    ['validate-cybersource-type-select', 'Card type doesn\'t match credit card number', function(v, elm) {
