...
/**
    ...
    */
    class Mycart_Payease_Adminhtml_Mdcybersource_CardsController extends Mage_Adminhtml_Controller_Action
    {
        ...
        public function editAction(){
            if($this->getRequest()->getParam('customer_card_id') > 0){
                echo $this->getLayout()->createBlock("mycart_payease/adminhtml_cards_edit_tab_editCard")->toHtml();
            }else{
                echo $this->getLayout()->createBlock("mycart_payease/adminhtml_cards_edit_tab_add")->toHtml(); 
            }
        }
        ...
        public function saveAction(){
            ...
            echo $append.Mage::app()->getLayout()->createBlock('mycart_payease/adminhtml_cards_edit_tab_form')->toHtml();
        }
        ...
        public function updateAction(){
            ...
            echo $append.Mage::app()->getLayout()->createBlock('mycart_payease/adminhtml_cards_edit_tab_form')->setData('update_Data',$params)->toHtml();
        }
