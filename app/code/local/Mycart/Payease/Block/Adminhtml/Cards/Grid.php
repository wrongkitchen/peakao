...
/**
    ...
    */
    class Mycart_Payease_Block_Adminhtml_Cards_Grid extends Mage_Adminhtml_Block_Widget_Grid
    {
        protected $_stores = array();
        protected $_helper = null;
        public function __construct(){
            parent::__construct();
            $this->_helper = Mage::helper('mycart_payease');
        ...
        protected function _prepareCollection() {
            $collection = Mage::getModel("mycart_payease/cards")
            ->getCollection();
