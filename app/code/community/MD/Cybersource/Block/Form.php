...
*/
class MD_Cybersource_Block_Form extends Mage_Payment_Block_Form_Cc
{
    ...
    public function getCustomerSavedCards(){       
        $cards = array();
        if(Mage::getModel("md_cybersource/config")->getIsActive()){
