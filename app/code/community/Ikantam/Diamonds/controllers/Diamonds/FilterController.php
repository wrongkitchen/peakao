...
class Ikantam_Diamonds_Diamonds_FilterController extends Mage_Core_Controller_Front_Action {
    /*
    ...
    public function diamondAction() {
        if ($this->_isAjax()) {
            ...
            /* @var $productListBlock Ikantam_Diamonds_Diamonds_Block_Product_List_Diamonds */
    ...
    public function ringAction() {
        ...
        if ($this->_isAjax()) {
            ...
            /* @var $productListBlock Ikantam_Diamonds_Diamonds_Block_Product_List_Rings */
    ...
    public function recentlyAction() {
        ...
        if ($this->_isAjax()) {
            ...
            /* @var $productListBlock Ikantam_Diamonds_Diamonds_Block_Product_List_Recently */
    ...
    private function _prepareAttributeFilterCondition($attribute) {
        ...
        /* @var $helper Ikantam_Diamonds_Diamonds_Helper_Data */
