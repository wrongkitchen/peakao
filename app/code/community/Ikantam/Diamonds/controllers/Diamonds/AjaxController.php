...
class Ikantam_Diamonds_Diamonds_AjaxController extends Mage_Core_Controller_Front_Action {
    ...
    public function refreshUrlRewriteAction() {
        ...
        $helper = new Ikantam_Diamonds_Diamonds_Diamonds_Helper_Data();
        ...
        $observer = new Ikantam_Diamonds_Diamonds_Diamonds_Model_Observer();
        $result = "";
