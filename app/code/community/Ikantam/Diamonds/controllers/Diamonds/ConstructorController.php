...
class Ikantam_Diamonds_Diamonds_ConstructorController extends Mage_Core_Controller_Front_Action {
    ...
    public function diamondAction() {
        ...
        if ($session->isRingSelected()) {
						$this->_redirect('*/diamonds_review/design');
          //  $this->addtocartAction();
            return;
        }

        $this->_redirect("*/diamonds_settings");
    }
    ...
    public function addtocartAction() {
        ...
        $bundle = new Ikantam_Diamonds_Diamonds_Model_Bundle();
