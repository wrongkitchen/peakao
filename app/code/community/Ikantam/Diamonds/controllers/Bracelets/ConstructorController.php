...
class Ikantam_Diamonds_Bracelets_ConstructorController extends Mage_Core_Controller_Front_Action {

    public function diamondAction() {

        $diamondId = (int) $this->getRequest()->getParam('diamond_id', null);
        $session = new Ikantam_Diamonds_Bracelets_Model_Session();
        ...
        if ($session->isRingSelected()) {
						$this->_redirect('*/review/design');
          //  $this->addtocartAction();
            return;
        }

        $this->_redirect("diamonds/settings");
    }
    ...
    public function addtocartAction() {
        ...
        $bundle = new Ikantam_Diamonds_Bracelets_Model_Bundle();
