...
class Ikantam_Diamonds_Earrings_AjaxController extends Mage_Core_Controller_Front_Action {
    ...
    public function refreshUrlRewriteAction() {
        ...
        $helper = new Ikantam_Diamonds_Earrings_Helper_Data();
        ...
        $observer = new Ikantam_Diamonds_Earrings_Model_Observer();
        $result = "";
