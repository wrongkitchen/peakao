...
class Ikantam_Diamonds_Earrings_ConstructorController extends Mage_Core_Controller_Front_Action {

    public function diamondAction() {

        $diamondId = (int) $this->getRequest()->getParam('diamond_id', null);
        $session = new Ikantam_Diamonds_Earrings_Model_Session();
    ...
    public function addtocartAction() {
        ...
        $bundle = new Ikantam_Diamonds_Earrings_Model_Bundle();
