<?php
class Ikantam_Diamonds_Earrings_IndexController extends Mage_Core_Controller_Front_Action
{
	public function indexAction()
	{
		...
		$this->loadLayout();
		/* @var $productList Ikantam_Diamonds_Earrings_Diamonds_Block_Product_List_Diamonds */
	...
	public function searchAction()
	{
		...
		if($query){
			...
			$resultSize = array();
			$diamonds = new Ikantam_Diamonds_Earrings_Diamonds_Block_Product_List_Diamonds();
			$resultSize['diamonds'] = $diamonds->getProductCollection()->getSize();
			
			$rings = new Ikantam_Diamonds_Earrings_Diamonds_Block_Product_List_Rings();
