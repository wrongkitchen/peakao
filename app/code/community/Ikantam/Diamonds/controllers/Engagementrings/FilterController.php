...
class Ikantam_Diamonds_Engagementrings_FilterController extends Mage_Core_Controller_Front_Action {
    /*
     * ajax filter products
     * 
     */
    public function catAction() {
		  $resultsBlock = $this->loadLayout()->getLayout()->getBlock('product_list');

            /* @var $productListBlock Ikantam_Diamonds_Engagementrings_Block_Product_List_Rings */
			...
			if ($attributes) {
                foreach ($attributes as $code => $attribute) {
                    ...
                    foreach ($value as $cond => $val) {
                       $resultsBlock->addFilterAttribute($code, array($cond => $val));
                    }
                }
            }
    ...
    public function diamondAction() {
        if ($this->_isAjax()) {
            ...
            /* @var $productListBlock Ikantam_Diamonds_Engagementrings_Block_Product_List_Diamonds */
    ...
    public function recentlyAction() {
        ...
        if ($this->_isAjax()) {
            ...
            /* @var $productListBlock Ikantam_Diamonds_Engagementrings_Block_Product_List_Recently */
    ...
    private function _prepareAttributeFilterCondition($attribute) {
        ...
        /* @var $helper Ikantam_Diamonds_Engagementrings_Helper_Data */
