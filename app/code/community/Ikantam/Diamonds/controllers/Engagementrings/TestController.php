...
class Ikantam_Diamonds_Engagementrings_TestController extends Mage_Core_Controller_Front_Action {
private $_product = null;
    public function IndexAction(){
        $cart = Mage::getSingleton('checkout/cart');
      $this->_product = Mage::getModel('catalog/product')->load(13);
            /* 22.08.2013 */
            //$existingItems = array();

            $this->_product->addCustomOption('ring_size',111);
