<?php
class Ikantam_Diamonds_Engagementrings_DebugController extends Mage_Core_Controller_Front_Action
{
    ...
    public function addselectionAction()
    {
    	...
    	$collection = Mage::getModel('catalog/product')->getCollection()
    			->addAttributeToFilter(
    					'attribute_set_id',
    					Ikantam_Diamonds_Engagementrings_Model_Config::RING_ATTRIBUTE_SET
    	);
