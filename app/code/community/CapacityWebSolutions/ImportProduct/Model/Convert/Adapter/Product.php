...
class CapacityWebSolutions_ImportProduct_Model_Convert_Adapter_Product extends Mage_Catalog_Model_Convert_Adapter_Product
{
    ...
    public function saveRow(array $importData)
    {
		...
		if ($field=="certificate_image" )  $value="/".$importData["name"]."/".$importData["name"]."-".$value;
			if ($field=="image" )  $value="/".$importData["name"]."/".$importData["name"]."-".$value;
			if ($field=="small_image" )  $value="/".$importData["name"]."/".$importData["name"]."-".$value;
			if ($field=="thumbnail" )  $value="/".$importData["name"]."/".$importData["name"]."-".$value;
			if ($field=="price_per_carat" )  $value=$importData["rapaport"]*$importData["discount"];
		   if ($field=="price_per_carat" )  $value=$importData["rapaport"]*$importData["discount"];
		    if($filed=="price") $value=$importData["rapaport"]*$importData["discount"]*$importData["carat"];
		 ...
		 */
	        try {
					 ...
					 */
	                {
							...
							$gallery_img="/".$importData["name"]."/".$importData["name"]."-".$gallery_img;
